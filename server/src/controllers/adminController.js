...
exports.adminLogin = async (req, res) => {
    ...
    try {
      ...
      res.status(200).json({ accessToken ,message: "Admin Login Successful" });
    } catch (error) {
...
exports.getUserCount = async (req, res) => {
    try {
        ...
        let adopterCount = 0, shelterCount = 0;
...
exports.getPetCount = async (req, res) => {
    try {
        ...
        let adoptedCount = 0, adoptableCount = 0;
        ...
        res.status(200).json({ adoptedCount, adoptableCount, petCount: totalPetCount });
    } catch (error) {
